...
### Trial 8: tune long range connections to get better contrast curves
### Trial 8a: long range connections added, now tune background firing rates

mult = float(sys.argv[1])
contrast = 0.
Chr2  = 'PV'   # "SOM" or "PV"
ChR2_str  = 0.  # Strength of the ChR2 stimulation [Use 0.08 for SOM or PV for instance]
p_far = 0.3 # proportion of SOM neurons with long-range connections
...
ext_syn_4  = StaticSynapse(weight=g_exc*mult, delay=0.1) # mult=2.5 originally
