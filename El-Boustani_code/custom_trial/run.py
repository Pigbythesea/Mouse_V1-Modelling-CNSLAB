...
sim_parameters = read_sim_params('rc_params_0124.txt')
sim_parameters['stim_type'] = 'SOM'
sim_parameters['contrast'] = 0.1
...
with open('result/test.pickle','wb') as f:
    pickle.dump(all_spikes,f)

print("EXC:", np.median(exc_rates))
print("PV:", np.median(pv_rates))
print("SOM:", np.median(som_rates))
