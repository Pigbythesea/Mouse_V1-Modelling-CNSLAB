...
def run_simulation(sim_parameters, condition, laserPosition, rngseed = '', verbose=False):
...
if __name__=="__main__":
    ...
    try:
        ...
        laserPosition = float(sys.argv[4])
    except IndexError:
        print("Provide four arguments: RNG seed, stimulation type (Spont, PV, or SST), contrast value (0-1), and position of laser (0-0.5)")
        sys.exit()
    ...
    run_simulation(sim_parameters, condition, laserPosition, rngseed = rngseed)
