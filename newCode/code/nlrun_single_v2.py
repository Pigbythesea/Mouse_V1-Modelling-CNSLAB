...
def run_simulation(sim_parameters, condition, rngseed = ''):
    ...
    if not sim_spontaneous:
        ...
        Chr2_times = np.array([200.+2000.*i for i in range(nb_repeats)]) # Induce an instantaneous synaptic conductance in the target population at time 0 every other trial
