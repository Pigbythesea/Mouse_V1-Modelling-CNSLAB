...
def run_simulation(sim_parameters, condition, rngseed = ''):
    ...
    simtime       = float(1000)          # ms Simulation time for each trial
    ...
    sim_delay     = 100.                # delay from t=0 to start of first stimulation
    ...
    if mm_site!='none':
        with open('%s/%s_rec_%s.pickle'%(result_dir,sim_name,mm_site), 'wb') as f:
